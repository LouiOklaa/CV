    ...
    <header>
      <div class="profile-page sidebar-collapse">
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
          <div class="container">
            <div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip">{{$information->name}}</a>
...
<div class="profile-page">
  <div class="wrapper">
    <div class="page-header page-header-small" filter-color="green">
      <div class="page-header-image" data-parallax="true" style="background-image: url('Attachments/Photo/{{$information->cover_photo}}')"></div>
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="Attachments/Photo/{{$information->profile_photo}}" alt="Image"/></a></div>
          <div class="h2 title">{{$information->name}}</div>
          <p class="category text-white">{{$information->work}}</p><a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Hire Me</a><a class="btn btn-primary" href="#" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Download CV</a>
        </div>
      </div>
      <div class="section">
        <div class="container">
          <div class="button-container">
              <a class="btn btn-default btn-round btn-lg btn-icon" href="{{$accounts->facebook_link}}" rel="tooltip" title="Follow me on Facebook"><i class="fa fa-facebook"></i></a>
              <a class="btn btn-default btn-round btn-lg btn-icon" href="{{$accounts->linkedin_link}}" rel="tooltip" title="Follow me on LinkedIn"><i class="fa fa-linkedin"></i></a>
              <a class="btn btn-default btn-round btn-lg btn-icon" href="{{$accounts->twitter_link}}" rel="tooltip" title="Follow me on Twitter"><i class="fa fa-twitter"></i></a>
              <a class="btn btn-default btn-round btn-lg btn-icon" href="{{$accounts->instagram_link}}" rel="tooltip" title="Follow me on Instagram"><i class="fa fa-instagram"></i></a>
              <a class="btn btn-default btn-round btn-lg btn-icon" href="{{$accounts->github_link}}" rel="tooltip" title="Follow me on Github"><i class="fa fa-github"></i></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">{{$accounts->email}}</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <div class="col-sm-8">{{$information->phone_number}}</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
              <div class="col-sm-8">{{$information->address}}</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Language:</strong></div>
              <div class="col-sm-8">{{$information->language}}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card-body">
        <div class="row">
            ...
            @foreach($skills as $one)
                ...
                @if($i%2 != 0)
                  <div class="col-md-6">
                    <div class="progress-container progress-primary"><span class="progress-badge">{{$one->skill_name}}</span>
                      <div class="progress">
                        <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: {{$one->skill_percentage}}%;"></div><span class="progress-value">{{$one->skill_percentage}}%</span>
                      </div>
                    </div>
                  </div>
                @else
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <p>{{$one->start_date}} - {{$one->end_date}}</p>
  ...
  <div class="cc-contact-information" style="background-image: url('images/staticmap.png')">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <p class="pb-2">{{$information->address}}</p>
                    <p class="mb-0"><strong>Phone</strong></p>
                    <p class="pb-2">{{$information->phone_number}}</p>
    ...
    <footer class="footer">
      ...
      <div class="text-center text-muted">
        <p>&copy; Creative CV. All rights reserved.<br>Design - <a class="credit" href="/login" target="_blank">Admin Login</a></p>
      </div>
    </footer>
